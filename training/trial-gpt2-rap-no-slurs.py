...
train_path = "./output/train_prp.csv"
test_path = "./output/test_prp.csv"
...
test_set = parse_test_set("./output/test_prp.csv")
text = list(test[0])
...
df.to_csv("./output/full_no_slurs_th3_test_summary.csv")